...
public class ITHealthCheckSuccessTest extends TestManager {
    ...
    private ServicechainDriverSuccessServer acwanServer = new ServicechainDriverSuccessServer();
    ...
    public void test() throws ServiceException {
        File createFile = new File("src/integration-test/resources/testcase/healthcheck.json");
